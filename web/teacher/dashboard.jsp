        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="list-group">
                    <a href="course?action=list" class="list-group-item list-group-item-action">Quản lý khóa học</a>
                    <a href="exam?action=create" class="list-group-item list-group-item-action">Tạo kỳ thi</a>
